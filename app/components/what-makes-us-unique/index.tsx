...
const WhatMakesUsUnique = () => {
  return (
    <section className="w-full flex flex-col md:flex-row gap-8 bg-white md:p-20 p-6 items-center">
      <div className="md:w-1/2 w-full">
        ...
        <h1 className="font-[700] text-black md:text-[40px] text-[30px]">
