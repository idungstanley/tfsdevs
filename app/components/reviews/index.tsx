  ...
  return (
    <section className="w-full flex-col flex gap-4 bg-[#F7F5FF] md:px-20 md:pt-20 p-6">
      <h1 className="font-[700] text-black md:text-[45px] text-[30px]">
        Our <span className="text-[#b49aeb]">Course</span> Offerings
      </h1>
      ...
      <div className="flex flex-col md:flex-row rounded-lg bg-white shadow-md mt-4">
        <Image alt="together" src="/together.jpg" width={700} height={700} className="md:rounded-l-lg rounded-t-lg" />
        <div className="bg-[#E8CCFA] md:rounded-r-lg rounded-b-lg px-8 py-6 gap-6 flex flex-col justify-center">
