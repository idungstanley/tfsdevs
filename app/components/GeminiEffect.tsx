...
//   title,
  ...
  return (
    <div className={cn('sticky top-40', className)}>
      ...
      <div className="w-full h-[890px] -top-20 md:-top-10  flex items-center justify-center bg-red-transparent absolute ">
        <button className="font-bold bg-white rounded-full md:px-4 md:py-2 px-2 py-1 md:mt-30 mt-8 z-30 md:text-base text-black text-xs  w-fit mx-auto ">
